...
namespace Examples
{
    ...
    internal class HelloTriangle : GameWindow
    {
        ...
        // TODO: Criar uma classe para gerenciar os buffers de dados, e permitir que o usuário configure os
        // atributosde cada buffer.
        ...
        /// <summary>
        /// Eventos de mouse (rodinha do mouse)
        /// </summary>
        /// <param name="e"></param>
