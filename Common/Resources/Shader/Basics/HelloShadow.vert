...
out VS_OUT
{
    ...
    vec3 tangentViewPos;
    vec3 tangentFragPos;
    vec4 fragPosLightSpace; // Nova variável de saída
} vs_out;

uniform mat4 model;
uniform mat4 view;
uniform mat4 projection;
uniform mat4 lightSpaceMatrix; // Nova variável uniforme
...
void main(void)
{
    ...
    vs_out.fragPosLightSpace = lightSpaceMatrix * vec4(fragPosition, 1.0); // Transforma a posição do fragmento para o espaço de luz
