...
namespace _3dCG.Examples.Basics
{
    internal class Chapter_14_HelloFrameBuffer : GameWindow
    {
        ...
        public Chapter_14_HelloFrameBuffer(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings) : base(gameWindowSettings, nativeWindowSettings)
        {
            Title = "Hello Frame Buffer!";
        }
